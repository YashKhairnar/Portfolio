...
export default function Work(){
    return (
        <div id="work" className="p-20">
            ...
            <div className="w-2/5 p-5 mr-5  bg-violet-950 border-b-4 rounded-md border-white">
        ...
        <div className="flex justify-center gap-5 font-poppins text-white  mt-5 mr-20">
            ...
            <div className="w-2/5 p-5 ml-5  bg-violet-950 border-b-4 rounded-md border-white">
